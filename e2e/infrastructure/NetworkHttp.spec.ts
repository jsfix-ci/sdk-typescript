...
describe('NetworkHttp', () => {
    ...
    describe('getNetworkType', () => {
        it('should return network type', async () => {
            const sentNetworkType = await lastValueFrom(networkRepository.getNetworkType());
    ...
    describe('getNetworkName', () => {
        it('should return network name and description', async () => {
            const networkName = await lastValueFrom(networkRepository.getNetworkName());
    ...
    describe('getTransactionFees', () => {
        it('should return transaction fees', async () => {
            const fees = await lastValueFrom(networkRepository.getTransactionFees());
    ...
    describe('getRentalFees', () => {
        it('should return rental fees', async () => {
            const fees = await lastValueFrom(networkRepository.getRentalFees());
    ...
    describe('getNetworkProperties', () => {
        it('should return network configuration', async () => {
            const config = await lastValueFrom(networkRepository.getNetworkProperties());
