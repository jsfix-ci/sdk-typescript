...
describe('NodeHttp', () => {
    ...
    it('getNodeHealth', async () => {
        ...
        const nodeHealth = await lastValueFrom(nodeRepository.getNodeHealth());
    ...
    it('getServerInfo', async () => {
        ...
        const serverInfo = await lastValueFrom(nodeRepository.getServerInfo());
    ...
    it('getNodeInfo', async () => {
        ...
        const nodeInfo = await lastValueFrom(nodeRepository.getNodeInfo());
    ...
    it('getNodePeers', async () => {
        ...
        const nodeInfoList = await lastValueFrom(nodeRepository.getNodePeers());
    ...
    it('getNodeTime', async () => {
        ...
        const nodeTime = await lastValueFrom(nodeRepository.getNodeTime());
    ...
    it('getNodeTim When No Timestamp', async () => {
        ...
        try {
            await lastValueFrom(nodeRepository.getNodeTime());
        } catch (e) {
    ...
    it('getUnlockedAccount', async () => {
        ...
        const unlockedAccount = await lastValueFrom(nodeRepository.getUnlockedAccount());
    ...
    it('getStorageInfo', async () => {
        ...
        const storageInfo = await lastValueFrom(nodeRepository.getStorageInfo());
    ...
    it('getStorageInfo on Exception on response body text', async () => {
        ...
        try {
            await lastValueFrom(nodeRepository.getStorageInfo());
        } catch (e) {
