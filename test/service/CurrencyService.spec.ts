...
describe('CurrencyService', () => {
    it('getNetworkProperties', async () => {
        ...
        const currencies = await lastValueFrom(service.getNetworkCurrencies());
    ...
    it('loadCurrencies', async () => {
        ...
        const service = new CurrencyService(repositoryFactory);
        const [currency, harvest] = await lastValueFrom(service.getCurrencies([currencyMosaicId, harvestingMosaicId]));
