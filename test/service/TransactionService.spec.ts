...
import { lastValueFrom, EMPTY, from, of as observableOf } from 'rxjs';
...
describe('TransactionService', () => {
    ...
    it('announce transaction when reject promise', async () => {
        ...
        try {
            await lastValueFrom(service.announce(signedTransaction, instance(listener)));
            expect(false).true;
        } catch (e) {
    ...
    it('announce when valid transaction', async () => {
        ...
        const transaction = await lastValueFrom(announcedTransaction);
    ...
    it('announce when status error', async () => {
        ...
        try {
            await lastValueFrom(announcedTransaction);
        } catch (e) {
